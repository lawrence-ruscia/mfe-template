...
/**
 * Purpose:
 * - A standardized structure for list and CRUD pages.
 * - It enforces structure and spacing, while allowing teams to fully customize what goes inside each region.
 */
